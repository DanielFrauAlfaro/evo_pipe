...
void GeoGraspEvo::compute() {
  ...
  float outliersThreshold = 2.5;
  int meanNeighbours = 25;
  ...
  // -----------------------------------------------------------------------------------------------
  // ---- IMPORTANTE: el filtro de outliers está desactivado, comenta esta línea para activarlo ----
  // -----------------------------------------------------------------------------------------------
  ...
  // candidatePointsVoxel = this->chosenPointsNormal[0];
  // candidatePointsVoxel1 = this->chosenPointsNormal[1];
